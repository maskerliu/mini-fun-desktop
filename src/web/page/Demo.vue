<template>
    <el-row style="height: 100%; padding: 0">
        <el-col :span="16" class="bg-border" style="height: calc(100vh - 60px)">
            <el-form label-width="200px" size="small" style="margin: 15px">
                <el-form-item label="网卡选择">
                    <el-select
                        v-model="wrapperConfig.serverIP"
                        placeholder="请选择"
                        size="small"
                        style="width: 100%"
                    >
                ...
                >
                    <el-input
                        v-model="wrapperConfig[item.key]"
                        size="small"
                        :disabled="item.key != 'dataProxyServer'"
                    >
                        <el-button
                            slot="append"
        ...
        <el-col
            :span="7"
            class="bg-border"
            style="padding: 5px; height: calc(100vh - 60px)"
        >
                ...
                >
                    <el-popover placement="bottom" trigger="manual">
                        <el-tooltip
                            ...
                            effect="dark"
                            placement="bottom"
                            :content="item.username + ' : ' + item.port"
                        >
                            <el-button
                                type="success"
        ...
        >
            <el-form label-width="100px">
                ...
                <el-input placeholder="请输入内容" v-model="imMsg" size="small">
                    <template slot="prepend"
                        ><i class="iconfont icon-msg-read"></i
                    ></template>
                    <el-button
                        slot="append"
                        icon="iconfont icon-send"
